...
class JobTopicUserPage extends ConsumerStatefulWidget {
  const JobTopicUserPage({super.key});

  @override
  ConsumerState<JobTopicUserPage> createState() => _JobTopicUserPageState();
}

class _JobTopicUserPageState extends ConsumerState<JobTopicUserPage> {
  @override
  void initState() {
    ...
    Future.microtask(() async {
      ...
      await controller.getJobTopicFavorite();
    });
  }
