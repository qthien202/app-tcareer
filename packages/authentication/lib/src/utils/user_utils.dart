...
import '../common/configs/shared_preferences_provider.dart';
import '../common/core/api/refresh_token_notifier.dart';
...
class UserUtils {
  ...
  Future<void> logout(BuildContext context) async {
    final sharedRef = await ref.read(sharedPreferencesProvider.future);
    sharedRef.remove(AppConstants.authToken);
    // ref.read(isAuthenticatedProvider.notifiers).update((state) => false);
    context.go("/login");
  }
